...
% ICASSP 2027 requires a valid ORCiD for every author; it must also be entered
% on the submission form, not only here.
\name{Abhiram Radhakrishnan\thanks{ORCiD
  \texttt{https://orcid.org/0009-0005-8766-7012}}}
\address{Sri Sai Ram Institute of Technology, Chennai, India \\
  \texttt{sec23am091@sairamtap.edu.in}}
...
We looked at them. Restricting attention to the audio condition---the condition
an SER system is actually being asked to emulate---listeners recover the
...
paper.\footnote{Repository link to be inserted on acceptance.}
